  ...
  return (
    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        className="flex flex-col gap-6 mt-6 text-6xl max-sm:text-5xl text-white max-w-[600px] w-auto h-auto"
        >
          <span>
          Providing  
        ...
        >
          I&apos;m a Full Stack Software Developer with experience in Website, Mobile, and Softwere development. Check out my projects and skills 
        </motion.p>
